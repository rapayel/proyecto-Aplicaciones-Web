...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `liberar_reservas_expiradas` ON SCHEDULE EVERY 2 MINUTE STARTS '2025-05-07 16:48:57' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
